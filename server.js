...
const cardGames = [
    {
        id: 'sexy-baccarat',
        name: 'Sexy Baccarat (บาคาร่า)',
        category: 'Live Casino',
        img: '/images/card_game/sexygame-portal.webp',
        desc: 'สัมผัสประสบการณ์คาสิโนสดระดับโลกกับดีลเลอร์สาวสวยสุดเซ็กซี่ ที่จะมาแจกไพ่พร้อมลีลาที่เร้าใจ ถ่ายทอดสดแบบ Real-time คมชัดระดับ 4K ไม่มีสะดุด',
        features: ['ดีลเลอร์สาวสวยใส่บิกินี่', 'ระบบวางเดิมพันเสถียรที่สุด', 'ดูเค้าไพ่ได้ง่ายดาย']
    },
    {
        id: 'pok-deng',
        name: 'Pok Deng 3D (ป๊อกเด้ง)',
        category: 'Table Game',
        img: '/images/acadame/kingmakers_menu.webp',
        desc: 'เกมไพ่ยอดฮิตคู่เมืองไทย ในรูปแบบ 3D อนิเมชั่นสวยงาม เล่นง่าย ได้เงินไว วัดดวงกับเจ้ามือ ลุ้นไพ่ป๊อก 8 ป๊อก 9 รับเงินรางวัลคูณ 2 เท่าทันที',
        features: ['กติกาแบบไทยแท้ๆ', 'เป็นเจ้ามือได้เอง', 'เล่นพร้อมเพื่อนได้หลายคน']
    },
    {
        id: 'dragon-tiger',
    ...
    {
        id: 'wild-bounty',
        name: 'Wild Bounty (ไพ่คาวบอย)',
        category: 'Slot',
        img: '/images/card_game/wild-bounty-showdown.webp',
        desc: 'สวมบทบาทคาวบอยล่าค่าหัว ดวลปืนสนั่นเมือง เกมสไตล์ตะวันตกที่มีกลิ่นอายของเกมโป๊กเกอร์ ผสมผสานกับสล็อตได้อย่างลงตัว แตกง่าย จ่ายหนัก',
        features: ['ตัวคูณเพิ่มทุกครั้งที่ชนะ', 'ฟรีสปินเริ่มต้น x8', 'กราฟิกสุดเท่']
    }
];
